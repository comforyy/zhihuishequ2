package com.jiuding.developer.zhihuishequ.Open;
...
public class Openthedoor extends View {
    ...
    /**
     * 通过handler来控制滑块在未解锁的时候，平缓滑动到的左端
     */
     ...
     * @param defStyle
     */
    public Openthedoor(Context context, AttributeSet attrs, int defStyle) {
    ...
    public Openthedoor(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Openthedoor(Context context) {
        this(context, null);
    }
