 ...
 */
public class YWTPayReqData implements Serializable {

    private static final long serialVersionUID = -112334617625404335L;
    /**
     * 请求时间,
     *格式：yyyyMMddHHmmss
    ...
    public YWTPayReqData(String dateTime, String branchNo, String merchantNo, String date, String orderNo, String amount,String expireTimeSpan, String payNoticeUrl, String returnUrl, String agrNo, String merchantSerialNo, String signNoticeUrl) {
